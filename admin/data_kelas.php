...
<body>
    ...
    <div class="container">
        <h1><i class="fas fa-school"></i> Data Kelas</h1>
        
        <div class="action-container">
            <a href="../fungsi/proses.php?table=kelas&aksi=tambah" class="crud-button add-button">
                <i class="fas fa-plus"></i> Tambah Kelas
            </a>
            <div class="search-container">
                <form action="" method="GET" class="search-form">
                    <input type="text" name="search" placeholder="Cari kelas berdasarkan tingkatan, jurusan, atau kelas..." 
        ...
        <table class="data-table">
            ...
            <tr>
                ...
                <td>
                    <a href="../fungsi/proses.php?table=kelas&aksi=edit&id=<?php echo $d['id_kelas']; ?>" class="crud-button edit-button">
                        <i class="fas fa-edit"></i> Edit
                    </a>
                    <a href="../fungsi/proses.php?table=kelas&aksi=hapus&id=<?php echo $d['id_kelas']; ?>" class="crud-button delete-button" 
