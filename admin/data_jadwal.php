...
<body>
    ...
    <div class="container">
        ...
        <div class="action-container">
            <a href="../fungsi/proses.php?table=jadwal&aksi=tambah" class="crud-button add-button">
                <i class="fas fa-plus"></i> Tambah Jadwal
            </a>
            <div class="search-container">
                <form action="" method="GET" class="search-form">
                    <input type="text" name="search" placeholder="Cari jadwal berdasarkan kelas, mapel, hari atau guru..." 
        ...
        <table class="data-table">
            ...
            $query = "SELECT * FROM view_jadwal_lengkap
                      WHERE nama_kelas LIKE '%$search%'
                      OR nama_mapel LIKE '%$search%'
            ...
            <tr>
                ...
                <td><?php echo $d['jam_mulai_format']; ?></td>
                <td><?php echo $d['jam_selesai_format']; ?></td>
                <td>
                    <a href="../fungsi/proses.php?table=jadwal&aksi=edit&id=<?php echo $d['id_jadwal']; ?>" class="crud-button edit-button">
                        <i class="fas fa-edit"></i> Edit
                    </a>
                    <a href="../fungsi/proses.php?table=jadwal&aksi=hapus&id=<?php echo $d['id_jadwal']; ?>" class="crud-button delete-button" 
