...
<body>
    ...
    <div class="container">
        ...
        <div class="action-container">
            <a href="../fungsi/proses.php?table=admin&aksi=tambah" class="crud-button add-button">
                <i class="fas fa-plus"></i> Tambah Admin
            </a>
            <div class="search-container">
                <form action="" method="GET" class="search-form">
                    <input type="text" name="search" placeholder="Cari admin berdasarkan nama..." 
        ...
        <table class="data-table">
            ...
            <tr>
                ...
                <td>
                    <a href="../fungsi/proses.php?table=admin&aksi=edit&id=<?php echo $d['id_admin']; ?>" class="crud-button edit-button">
                        <i class="fas fa-edit"></i> Edit
                    </a>
                    <a href="../fungsi/proses.php?table=admin&aksi=hapus&id=<?php echo $d['id_admin']; ?>" class="crud-button delete-button" 
