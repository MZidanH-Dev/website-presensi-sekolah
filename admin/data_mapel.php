...
<body>
    ...
    <div class="container">
        ...
        <div class="action-container">
            <a href="../fungsi/proses.php?table=mapel&aksi=tambah" class="crud-button add-button">
                <i class="fas fa-plus"></i> Tambah Mapel
            </a>
            <div class="search-container">
                <form action="" method="GET" class="search-form">
                    <input type="text" name="search" placeholder="Cari mata pelajaran..." 
        ...
        <table class="data-table">
            ...
            <tr>
                ...
                <td>
                    <a href="../fungsi/proses.php?table=mapel&aksi=edit&id=<?php echo $d['id_mapel']; ?>" class="crud-button edit-button">
                        <i class="fas fa-edit"></i> Edit
                    </a>
                    <a href="../fungsi/proses.php?table=mapel&aksi=hapus&id=<?php echo $d['id_mapel']; ?>" class="crud-button delete-button" 
