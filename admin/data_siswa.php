...
<body>
    ...
    <div class="container">
        ...
        <div class="action-container">
            <a href="../fungsi/proses.php?table=siswa&aksi=tambah" class="crud-button add-button">
                <i class="fas fa-plus"></i> Tambah Siswa
            </a>
            <div class="search-container">
                <form action="" method="GET" class="search-form">
                    <input type="text" name="search" placeholder="Cari siswa berdasarkan nama, NISN, atau kelas..." 
        ...
        <table class="data-table">
            ...
            $query = "SELECT * FROM view_siswa_kelas 
            ...
            <tr>
                ...
                <td>
                    <a href="../fungsi/proses.php?table=siswa&aksi=edit&id=<?php echo $d['id_siswa']; ?>" class="crud-button edit-button">
                        <i class="fas fa-edit"></i> Edit
                    </a>
                    <a href="../fungsi/proses.php?table=siswa&aksi=hapus&id=<?php echo $d['id_siswa']; ?>" class="crud-button delete-button" 
